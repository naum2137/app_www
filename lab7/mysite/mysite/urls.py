...
from app_www.views import OsobaListCreate, OsobaDetail, StanowiskoListCreate, StanowiskoDetail, OsobaUpdateView, OsobaDeleteView, StanowiskoMembersView, osoba_view
